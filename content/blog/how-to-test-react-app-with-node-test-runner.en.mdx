...
> I really recommend you to read the [Node.js Test Runner documentation](https://nodejs.org/en/learn/test-runner/introduction) to understand how node.js test runner works.
...
> **Note**: The rest of the dependencies we will use come from your runtime (Node.js).
...
> If you want to understand what is a loader. You need to read [this post](/blog/post/how-to-use-nodejs-loader) I had written about loaders.
