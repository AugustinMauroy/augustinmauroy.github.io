...
## Installing the dependencies you need

Theses dep is in addition of your React app dependencies

```bash
npm install --save-dev @testing-library/react @testing-library/dom jsdom
```

> **Note**: The rest of dependencies we will use come from your runtime (node.js).
